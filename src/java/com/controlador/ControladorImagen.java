 ...
 * @author IrminDev
 * 
 * Servlet encargado de mostrar las imágenes de perfil que sean requeridas
 */
...
public class ControladorImagen extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //Obtenemos el id que es pasado apartir de la solicitud de un recurso (Ej. src="ControladorImagen?id=19" donde el id es 19)
        int id = Integer.parseInt(request.getParameter("id"));
        //Abrimos un try-ctach para hacer la conversión de bytes a una imágen
        try{
            //Ejecutamos el método que mostrará la imágen de perfil
