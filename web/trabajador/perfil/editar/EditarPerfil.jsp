...
<body>
    ...
    <header class="header scroll-header" id="header">
        <nav class="nav container">
            ...
            <!-- ICONO DEL USUARIO -->
            <img src="../../../ControladorImagen?id=<% out.print(idUsuario); %>" alt="user" class="nav_img">
        </nav>
    </header>
    <div class="content">
        ...
        <form action="../../../ControlUsuarios" method="POST" id="Cambios" enctype="multipart/form-data">
            ...
            <button class="form-button" type="submit" name="accion" value="HacerCambio" onclick="return enviarCambios()">Editar perfil</button>
        </form>
    </div>
